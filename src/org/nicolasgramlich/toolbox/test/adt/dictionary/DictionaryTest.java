package org.nicolasgramlich.toolbox.test.adt.dictionary;
...
import org.nicolasgramlich.toolbox.adt.dictionary.Dictionary;
...
public class DictionaryTest {
	...
	public void testCreateFromInputStream() throws URISyntaxException, IOException {
		final InputStream inputStream = DictionaryTest.class.getClassLoader().getResourceAsStream("dictionary.txt");

		long ms = System.currentTimeMillis(); 
		final String[] expected = Util.readLines(inputStream);
